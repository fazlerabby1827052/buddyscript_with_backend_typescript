...
import { addpost, setpost } from "../redux/CounterSlice";
...
export default  function Post() {
  ...
  return (<div className="container _custom_container">
      <div className="_layout_inner_wrap">
        <div className="row">
          {/* <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12"></div>//leftsidebar */}
          <LeftSidebar/>
          ...
          {/* <div className="col-xl-3 col-lg-3 col-md-12 col-sm-12"></div>//rightsidebar */}
          <RightSidebar/>
        </div>
      </div>
    </div>)
